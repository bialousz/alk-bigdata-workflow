...
customers_with_debit = spark.sql("""SELECT DISTINCT name, surname, customer_id from customers_with_all_data where rounded_account_balance == rounded_transaction and rounded_account_balance < 0""")

customers_with_debit.write.format("com.google.cloud.spark.bigquery").option("table", sys.argv[4]).save()